...
used to control the order of certain data structures (such as sorted sets or sorted maps), or to provide an ordering for
collections of objects that don't have a natural ordering.<br>
...
The solution to this problem is The Comparator interface which can act as a third party comparator which Take two object
of a same type.<br>
